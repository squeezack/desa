        ...
        <div class="col-md-12">
          ...
          <div class="box">
            <div class="box-header">
              ...
              <h3 class="box-title">Kegiatan Desa</h3>
            </div>
            <!-- /.box-header -->
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="text-center">
                      <a class="btn btn-sm btn-primary" href="<?php echo base_url('admin/aktifitas/edit/'.$row->id_aktifitas) ?>">
                        <i class="fa fa-edit"></i>
                      </a>
                      <a href="<?php echo base_url('admin/aktifitas/delete/'.$row->id_aktifitas); ?>" class="btn btn-sm btn-danger" onclick="return confirm('Konfirmasi menghapus data');">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="<?php echo base_url('admin/aktifitas/add'); ?>" enctype="multipart/form-data">

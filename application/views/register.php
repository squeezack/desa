...
<div class="login-box">
  <div class="login-logo">
    <a href=""><b>Daftar</b> | Desa Pangulu Nagori Naga Soppa</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <form method="post" action="<?php echo base_url('login/register'); ?>">
      ...
      <div class="form-group has-feedback">
        <input type="text" class="form-control" placeholder="081312312312" name="no_hp" required>
      ...
      <div>
        <p>Sudah punya akun? <a href="/daftar">Masuk disini</a></p>
      </div>
      <br>
      <div class="row">
        <div class="col-xs-6">
